        ...
        <section className={`${cardSurface} p-8`}>
          ...
          <div className="mt-6">
            <EmptyState
              ...
              description="Ocorreu um erro ao carregar seus projetos. Tente novamente."
    ...
    <>
      ...
      {projectToDelete && (
        <div className={modalOverlay} onClick={() => setProjectToDelete(null)}>
          ...
          >
            <h3 className="text-lg font-semibold mb-2">Deletar projeto</h3>
